...
def main(args=None):
    ...
    if args.dataset_type == 'coco':
        ...
        writer.writerow([sum(precisions), sum(x > 0 for x in total_instances), sum(precisions) / sum(x > 0 for x in total_instances)])


if __name__ == '__main__':
    csv_file = open('keras_retinanet/result/mAP.csv', 'a+', newline='')
